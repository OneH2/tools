...
if __name__=='__main__':
	...
	while True:
		...
		data.extend(split32(encode_ieee(shunt_voltage)))
		
		data.extend(split32(encode_ieee(bus_voltage)))

		data.extend(split32(encode_ieee(current/1000)))

		data.extend(split32(encode_ieee(power)))

		data.extend(split32(encode_ieee(p)))
